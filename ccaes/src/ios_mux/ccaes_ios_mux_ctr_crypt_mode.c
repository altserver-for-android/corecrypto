...
static int
ccaes_ios_mux_ctr_crypt(ccctr_ctx *ctrctx, size_t nbytes, const uint8_t *in, uint8_t *out)
{
...
static int
ccaes_ios_mux_ctr_crypt_wrapper(ccctr_ctx *ctrctx, size_t nbytes, const void *in, void *out)
{
    return ccaes_ios_mux_ctr_crypt(ctrctx, nbytes, in, out);
}
...
const struct ccmode_ctr *ccaes_ios_mux_ctr_crypt_mode()
{
    ...
    ccaes_ios_mux_ctr_crypt_mode.ctr = ccaes_ios_mux_ctr_crypt_wrapper;
