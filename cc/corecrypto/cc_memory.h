...
struct cc_ws {
    ...
    void (*CC_SPTR(cc_ws, clear))(cc_ws_t ws);
...
#define CC_DECL_WORKSPACE_RV(ws, n, rv)                                        \
    ...
    cc_ws ws##_ctx = { ws##_buf, n, 0, cc_ws_alloc, cc_ws_clear, cc_ws_free }; \
    cc_ws_t ws = &ws##_ctx;                                                    \
    if (NULL == ws->ctx)                                                       \
...
#define CC_DECL_WORKSPACE_RV(ws, n, rv)                                              \
    ...
    cc_ws ws##_ctx = { ws##_buf, n, 0, cc_ws_alloc, cc_ws_clear, cc_ws_free_stack }; \
    cc_ws_t ws = &ws##_ctx;                                                          \
    cc_ws_alloc_debug(&ws, __FILE__, __LINE__, __func__);
