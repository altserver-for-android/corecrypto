...
// 2048-bit RSA with SHA-256 as RSA-PSS Mask Generation Function and Message Hashing
extern const struct ccrsabssa_ciphersuite ccrsabssa_ciphersuite_rsa2048_sha256 __attribute__((deprecated("Use of RSABSSA with SHA-256 is being deprecated and will no longer be available in a later build.")));
// 3072-bit RSA with SHA-256 as RSA-PSS Mask Generation Function and Message Hashing
extern const struct ccrsabssa_ciphersuite ccrsabssa_ciphersuite_rsa3072_sha256 __attribute__((deprecated("Use of RSABSSA with SHA-256 is being deprecated and will no longer be available in a later build.")));
