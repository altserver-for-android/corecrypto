...
static int ccrsa_is_valid_prime_ws(cc_ws_t ws, cc_size np, const cc_unit *p,
                                   cc_size ne, const cc_unit *e, size_t mr_depth,
                         ...
                         struct ccrng_state *rng)
{
    ...
    int rv = ccrsa_is_valid_prime_ws(ws, np, p, ne, e, mr_depth, rng);
