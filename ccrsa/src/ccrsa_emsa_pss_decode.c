                          ...
                          const uint8_t *EM)
{
    ...
    CC_DECL_WORKSPACE_OR_FAIL(ws, CCRSA_EMSA_PSS_DECODE_CANARY_OUT_WORKSPACE_N(ccn_nof(emBits)));
    int rv = ccrsa_emsa_pss_decode_canary_out_ws(ws, di, MgfDi, sSize, mSize, mHash, emBits, EM, unused_fault_canary);
