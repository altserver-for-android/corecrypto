...
struct ccsigma_mfi_ctx {
    ...
    struct {
        ccec_full_ctx_decl(ccn_sizeof(CCSIGMA_MFI_KEX_CP_BITSIZE), ctx);
        ccec_pub_ctx_decl(ccn_sizeof(CCSIGMA_MFI_KEX_CP_BITSIZE), peer_ctx);
    } key_exchange;
    struct {
        ccec_full_ctx_decl(ccn_sizeof(CCSIGMA_MFI_SIG_CP_BITSIZE), ctx);
        ccec_pub_ctx_decl(ccn_sizeof(CCSIGMA_MFI_SIG_CP_BITSIZE), peer_ctx);
    } signature;
