...
static void
ccsigma_round_trip(void)
{
    const struct ccsigma_info *info = ccsigma_mfi_info();
    int err;
    ...
    ccec_x963_export(1, init_signing_key, init_signing_ctx);
    ...
    ccec_x963_export(1, resp_signing_key, resp_signing_ctx);
...
ccsigma_kat(struct sigma_kat *kat)
{
    ...
    ok_memcmp_or_goto(resp_mfi_ctx.session_keys_buffer, kat->session_keys, sizeof(kat->session_keys), errout, "ccsigma_kat/session_keys/resp");
    ...
    ok_memcmp_or_goto(init_mfi_ctx.session_keys_buffer, kat->session_keys, sizeof(kat->session_keys), errout, "ccsigma_kat/session_keys/init");
...
#define ccsigma_round_trip_ntests (36)
#define ccsigma_kat_ntests (20)

int
ccsigma_tests(TM_UNUSED int argc, TM_UNUSED char *const *argv)
{
    plan_tests(ccsigma_round_trip_ntests +
