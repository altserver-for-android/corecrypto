...
#define ccdigest_u8(_state_)             (((ccdigest_state_t)(_state_))->state)
#define ccdigest_u32(_state_)            ((uint32_t *)((ccdigest_state_t)(_state_))->state)
#define ccdigest_u64(_state_)            ((uint64_t *)((ccdigest_state_t)(_state_))->state)
#define ccdigest_ccn(_state_)            ((cc_unit *)((ccdigest_state_t)(_state_))->state)
