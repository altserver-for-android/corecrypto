...
struct ccz_class {
	void *ctx;
    // rdar://74314942 (Can't annotate function pointer return value)
...
CC_NONNULL((1, 3))
void ccz_write_radix(const ccz *s, size_t out_size, void *cc_sized_by(out_size) out, unsigned radix);
