                                      ...
                                      ccec_const_projective_point_t t)
{
    ...
    cc_require(ccec_mult_inner_ws(ws, cp, tp, d0, cczp_bitlen(zq), s) == CCERR_OK, errOut);
    cc_require(ccec_mult_inner_ws(ws, cp, r, d1, cczp_bitlen(zq), t) == CCERR_OK, errOut);
...
#pragma workspace-override ccec_verify_twinmult_ws ccec_verify_singlemults_ws
#pragma workspace-override ccec_verify_twinmult_ws ccec_twin_mult_ws
...
#pragma workspace-override ccec_verify_computemults_ws ccec_verify_twinmult_ws
#pragma workspace-override ccec_verify_computemults_ws ccec_verify_singlemults_ws
                            ...
                            cc_fault_canary_t fault_canary_out)
{
    ...
    // e (mod q)
    if (ccn_sub(n, w, e, cczp_prime(zq)) == 0) {
        ccn_set(n, e, w);
    }
    ...
    result = ccec_projectify_ws(ws, cp, mg, ccec_cp_g(cp), NULL);
